        ...
        <div class="bento-grid">
            ...
            <div class="info-card d-flex flex-column gap-4" data-aos="fade-up" data-aos-delay="100">
                <div class="bento-card h-100 p-4">
                    ...
                    <a href="mailto:support@stockflowkp.com" class="text-primary fw-bold text-decoration-none">support@stockflowkp.com</a>
                </div>
        ...
        <div class="container text-center text-md-start">
            <div class="row align-items-center">
                <div class="col-md-6">
                    ...
                    <p class="text-muted small mt-2 mb-0">© 2024 StockflowKP. Enterprise Duka Solutions.</p>
                </div>
