...
class ProductCategoryController extends Controller
{
    ...
    public function show(ProductCategory $productCategory)
    {
        ...
        return view('categories.show', ['category' => $productCategory, 'duka' => $duka]);
    }
   ...
   public function edit(ProductCategory $productCategory)
{
    ...
    public function import(Request $request)
    {
        ...
        try {
            ...
            \Maatwebsite\Excel\Facades\Excel::import(new \App\Imports\CategoriesImport($tenantId), $request->file('file'));
    ...
    public function downloadImportTemplate()
    {
        ...
        $callback = function () {
            ...
            fputcsv($handle, ['name', 'description', 'status']); // Header row
            fputcsv($handle, ['Electronics', 'Devices and gadgets', 'active']); // Sample row
            fclose($handle);
        };
