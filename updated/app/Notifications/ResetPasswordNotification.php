...
class ResetPasswordNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        $subject = 'Reset Your StockflowKP Password';
        $actionText = 'Reset Password';
        $introLine = 'You are receiving this email because we received a password reset request for your StockflowKP account.';
        ...
        $salutation = 'Best regards, StockflowKP Team';
