                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge bg-{{ in_array(strtolower($movement->type), ['in', 'add']) ? 'success' : 'danger' }}">
                                                    {{ strtoupper($movement->type) }}
                                                </span>
                                            </td>
                                            <td class="fw-bold {{ in_array(strtolower($movement->type), ['in', 'add']) ? 'text-success' : 'text-danger' }}">
                                                {{ in_array(strtolower($movement->type), ['in', 'add']) ? '+' : '-' }}{{ abs($movement->quantity_change) }}
                                            </td>
