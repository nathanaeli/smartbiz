                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="horizontal-menu" data-bs-parent="#sidebar-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ Route::currentRouteName() === 'duka.setting' ? 'active' : '' }}"
                                    href="{{ route('duka.setting') }}">
                                    <i class="icon me-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="12" class="text-gradient"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <circle cx="12" cy="12" r="8" />
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Route::currentRouteName() === 'tenant.sales.index' ? 'active' : '' }}"
                            href="{{ route('tenant.sales.index') }}">
                            <i class="icon">
                                <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M3 3H5L5.4 5M5.4 5H21L17 13H7M5.4 5L7 13m0 0L5 18H19M7 13L5 18M10 21C10 21.5523 9.55228 22 9 22C8.44772 22 8 21.5523 8 21C8 20.4477 8.44772 20 9 20C9.55228 20 10 20.4477 10 21ZM18 21C18 21.5523 17.5523 22 17 22C16.4477 22 16 21.5523 16 21C16 20.4477 16.4477 20 17 20C17.5523 20 18 20.4477 18 21Z"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                            </i>
                            <span class="item-name">{{ __('messages.sales') }}</span>
                        </a>
                    </li>
