...
<head>
    ...
    <title>SMARTBIZ - Officer Panel</title>
        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ $currentRoute === 'officer.proformainvoice' ? 'active' : '' }}"
                            href="{{ route('officer.proformainvoice') }}">
                            <i class="icon">
                                <svg width="20" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg" class="icon-20">
                                    <path opacity="0.4"
                            ...
                            <span class="item-name">Proforma Invoice</span>
                        </a>
                    </li>
                        ...
                        <div class="col-md-12">
                            <div class="flex-wrap d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <p>Welcome to SMARTBIZ Officer Panel. Manage your assigned tasks and permissions.
                                    </p>
                                </div>
                            </div>
                        </div>
